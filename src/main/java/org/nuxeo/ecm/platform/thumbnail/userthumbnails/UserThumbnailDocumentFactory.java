...
public class UserThumbnailDocumentFactory extends ThumbnailDocumentFactory {

    private static final Log log = LogFactory.getLog(UserThumbnailDocumentFactory.class);
